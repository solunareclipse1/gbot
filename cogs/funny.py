...
class funny(commands.Cog):
    ...
    async def robotnik(self, ctx, target = None):
        ...
        embed = embedMessage.embed(
            ...
            sections = [("Retweets",rts), ("Likes",likes)],
            footer = f'Twitter • {datetime.datetime.now().strftime("%m/%d/%y")}'
        )
